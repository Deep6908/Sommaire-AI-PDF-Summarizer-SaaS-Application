...
export const buttonVariants = {
    scale: 1.05,
    transition: {
        type: 'spring' as import('framer-motion').AnimationGeneratorType,
        stiffness: 300,
        damping: 10,
    }
}
...
export default function HeroSection() {
    ...
    items-center justify-center py-16 sm:py-20 lg:pb-28 transition-all animate-in
    lg:px-12 max-w-7xl">
            ...
            lg:px-0 lg:max-w-4xl text-gray-600">Get a beautiful summary reel of the document in seconds.</MotionH2>
            <MotionDiv
                variants={itemVariants} whileHover={{ scale: 1.05 }}>
                <Button 
                variant={'link'} 
                className="text-white mt-6 text-base
                sm:text-lg lg:text-xl rounded-full px-8 sm:px-10 lg:px-12 py-6
